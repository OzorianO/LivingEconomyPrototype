...
смерть/loot і поведінка бізнесу без власника ще попереду.
...
читач підтримує v1/v2/v3/v4/v5.
...
18.09.2026: PASS, 31 156 тверджень ядра, включно з 100-денними продовженнями,
збереженням грошей, атомарністю, порядком подій, наймом, звітами та XML.
Додатково PASS, 200 перевірок у Unity: реальне перезавантаження коду, карта,
...
first-person та безпечне відновлення героя.
[Результат Unity](Docs/M1C_POSE_UI_RELOAD_RESULT.txt).
